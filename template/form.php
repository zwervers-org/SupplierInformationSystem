<?php
echo '	<link rel="stylesheet" href="./template/form.css" type="text/css">';
echo '<div id="formframe">';
	...
	if (!in_array($_GET['page'], $nopresent)){
		if (in_array($username, $admin) or in_array($username, $moderator)){
			echo'<h1 class="click" onclick="return showHide(DisplayPresent);">Display existing data</h1>';
	}}	
	...
	//present entry data
			echo '<div id="DisplayPresent" style="display:none;">';
